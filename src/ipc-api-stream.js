'use strict'
// [I]nter[P]rocess [C]ommunication API

// TODO factor this out to `ultra-api` -prf
// TODO factor createIpcStream into `pull-ipc` -prf
...
// from ultra process:
// var stream = ipcApiStream(app.process, function() { console.log('ipc stream is closed') })

// from child process:
// var stream = ipcApiStream(process, function() { console.log('ipc stream is closed') })

// then:
// var api = muxrpc(theirApiManifest, myApiManifest/*, serialize*/)(myApiDefinition)
